...
class EmailTemplateServer {
    ...
    setupHandlers() {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            try {
                switch (name) {
                    case 'generate_template': return await this.generateTemplate(args?.templateName, args?.purpose);
                    case 'preview_template': return await this.previewTemplate(args?.templateName, args?.data || '{}');
    ...
    async generateTemplate(templateName, purpose) {
        const templates = {
            'welcome': `
<!DOCTYPE html>
<html>
...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
    ...
    async previewTemplate(templateName, dataJson) {
