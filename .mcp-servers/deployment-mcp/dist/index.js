...
class DeploymentServer {
    ...
    setupHandlers() {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            try {
                switch (name) {
                    case 'deploy_service': return await this.deployService(args?.service, args?.environment);
                    case 'rollback': return await this.rollback(args?.service, args?.environment);
    ...
    async rollback(service, environment) {
