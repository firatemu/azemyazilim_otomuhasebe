...
function ClassicTemplate({ 
  ...
  return (
    ...
    >
      ...
      {/* Tedarikçi Bilgileri */}
      <Box sx={{ mb: 3, p: 2, bgcolor: '#ecfeff', borderRadius: 1, border: '1px solid #a5f3fc' }}>
        ...
        <Table size="small" sx={{ 
          ...
          <TableBody>
            {fatura.kalemler.map((kalem, index) => (
              <TableRow key={kalem.id} sx={{ '&:nth-of-type(even)': { bgcolor: '#ecfeff' } }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 2 }}>
        <Box sx={{ width: paperSize === 'A4' ? '250px' : '180px' }}>
          <Stack spacing={0.5} sx={{ p: 2, bgcolor: '#ecfeff', borderRadius: 1, border: '1px solid #a5f3fc' }}>
            ...
            {fatura.iskonto > 0 && (
              <Stack direction="row" justifyContent="space-between">
                ...
                <Typography sx={{ fontSize: '9pt', color: '#0891b2' }}>-{formatMoney(fatura.iskonto)}</Typography>
              </Stack>
            )}
            <Stack direction="row" justifyContent="space-between">
      ...
      {/* Açıklama */}
      {fatura.aciklama && (
        <Box sx={{ mt: 2, p: 1.5, bgcolor: '#ecfeff', borderRadius: 1, border: '1px solid #a5f3fc' }}>
      ...
      <Box sx={{ position: 'absolute', bottom: paperSize === 'A4' ? 30 : 15, left: paperSize === 'A4' ? 30 : 15, right: paperSize === 'A4' ? 30 : 15 }}>
        ...
        <Typography variant="caption" align="center" display="block" sx={{ color: '#666' }}>
          Bu belge satınalma iade faturası bilgi amaçlı hazırlanmıştır.
        </Typography>
      </Box>
    </Paper>
  );
  ...
  return (
    ...
    >
      ...
      <Box sx={{ p: paperSize === 'A4' ? 4 : 2 }}>
        ...
        {fatura.aciklama && (
          <Box sx={{ mt: 2 }}>
            <Typography variant="caption" sx={{ color: '#06b6d4', fontWeight: 'bold', textTransform: 'uppercase' }}>
              Notlar
            </Typography>
