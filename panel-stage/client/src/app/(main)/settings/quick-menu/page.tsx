...
const menuItems = [
  ...
  { id: 'stok-malzeme-hareketleri', label: 'Malzeme Hareketleri', path: '/product/malzeme-hareketleri' },
  { id: 'cari-liste', label: 'Cari Listesi', path: '/account' },
  { id: 'fatura-satis', label: 'Satış Faturaları', path: '/invoice/sales' },
  { id: 'fatura-alis', label: 'Satın Alma Faturaları', path: '/invoice/alis' },
  { id: 'teklif-satis', label: 'Satış Teklifleri', path: '/teklif/satis' },
  { id: 'siparis-satis', label: 'Satış Siparişleri', path: '/order/satis' },
